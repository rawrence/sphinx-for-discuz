...
/*
	...
	$Id: search.php 13383 2008-04-11 09:35:34Z heyond $
*/
...
if(!submitcheck('searchsubmit', 1)) {
	...
	/*if($srchtype == 'qihoo') {
		...
		exit();*/
	// 全文插件代码开始 coreseek fulltext search plugin head
	if($srchtype == 'title' || $srchtype == 'fulltext') {

		//require DISCUZ_ROOT.'/search_coreseek.php';
	...
	// 全文插件代码结束 coreseek fulltext search plugin tail
	if($srchtype == 'qihoo') {
